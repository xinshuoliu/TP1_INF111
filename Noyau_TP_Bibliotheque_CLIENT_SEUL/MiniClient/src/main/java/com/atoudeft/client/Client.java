...
public class Client implements Lecteur {
    ...
    /**
     * Créer un client en lui initialisant un gestionnaire d'événements par défaut.
     */
    public Client() {
    ...
    public void setGestionnaireEvenementClient(GestionnaireEvenementClient gestionnaireEvenementClient) {
