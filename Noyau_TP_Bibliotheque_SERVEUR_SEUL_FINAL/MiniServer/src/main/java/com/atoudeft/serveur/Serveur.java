...
public class Serveur implements Lecteur {
    ...
    public boolean demarrer() {
        ...
        try {
            ...
            ecouteurTexte.start();
            /*
             * Le gestionnaire d'evenements du serveur est l'objet qui recoit
             * les commandes envoyees par les clients et qui decide comment les
             * traiter. Au depart, GestionnaireEvenementServeur renvoie simplement
             * les messages en majuscules. Dans le TP, le traitement de la
             * bibliotheque devra etre integre a ce niveau.
             */
    ...
    public synchronized void lire() {
        ...
        for (int i=0;i<connectes.size();i++) {
            ...
            if (!"".equals(texte)) {
                ...
                /*
                 * A ce moment, le serveur a recu une commande du client.
                 * Il cree un evenement, puis il demande au gestionnaire
                 * d'evenements de traiter cette commande.
                 */
